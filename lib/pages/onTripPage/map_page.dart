import 'dart:math';
import 'package:adrenod_user/functions/notifications.dart';
import 'package:adrenod_user/pages/NavigatorPages/notification.dart';
import 'package:adrenod_user/pages/onTripPage/booking_confirmation.dart';
import 'package:adrenod_user/pages/onTripPage/drop_loc_select.dart';
import 'package:adrenod_user/pages/login/login.dart';
import 'package:adrenod_user/pages/noInternet/nointernet.dart';
import 'package:adrenod_user/translations/translation.dart';
import 'package:uuid/uuid.dart';
import 'package:firebase_database/firebase_database.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:adrenod_user/functions/functions.dart';
import 'package:adrenod_user/functions/geohash.dart';
import 'package:adrenod_user/pages/loadingPage/loading.dart';
import 'package:adrenod_user/styles/styles.dart';
import 'package:google_maps_flutter/google_maps_flutter.dart';
import 'dart:async';
import 'package:location/location.dart';
import 'package:adrenod_user/widgets/widgets.dart';
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      (_dropaddress == true &&
                                                                          ...
                                                                          ? Expanded(
                                                                              child: TextField(
                                                                                  autofocus: true,
                                                                                  decoration: InputDecoration(contentPadding: (languageDirection == 'rtl') ? EdgeInsets.only(bottom: media.width * 0.035) : EdgeInsets.only(bottom: media.width * 0.047), border: InputBorder.none, hintText: "Search Drop Location", hintStyle: GoogleFonts.roboto(fontSize: media.width * twelve, color: hintColor)),
                                                                                  maxLines: 1,
                                                                                  onChanged: (val) {
                                                                                    _debouncer.run(() {
                                                                                      if (val.length >= 4) {
