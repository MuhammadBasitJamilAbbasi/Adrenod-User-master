...
import 'package:adrenod_user/pages/NavigatorPages/editprofile.dart';
import 'package:adrenod_user/pages/NavigatorPages/history.dart';
import 'package:adrenod_user/pages/NavigatorPages/makecomplaint.dart';
import 'package:adrenod_user/pages/loadingPage/loadingpage.dart';
import 'package:adrenod_user/pages/onTripPage/booking_confirmation.dart';
import 'package:adrenod_user/pages/login/get_started.dart';
import 'package:adrenod_user/pages/login/login.dart';
import 'package:adrenod_user/pages/onTripPage/map_page.dart';
import 'package:adrenod_user/pages/onTripPage/review_page.dart';
import 'package:adrenod_user/pages/referralcode/referral_code.dart';
...
//base url
String url ='https://adrenod.com/'; //please add '/' at the end of url as 'yourwebsite.com/'
// String url = 'https://mymtadminnew.mototransnow.com/'; //add '/' at the end of url as 'yourwebsite.com/'

// String url ='https://adrenod.scriptro.com/'; //please add '/' at the end of url as 'yourwebsite.com/'
String mapkey = 'AIzaSyCoSY5ObOldlyJwC-42GTnQZfBRdW0pSHw';
// String mapkey_web='AIzaSyC3JcZpdo2fbgCQIskws-YgzJz8o1U6bRY';

// AIzaSyCilsQ09AlsLXYmPD6CLUp1lXWb3wkBv8o
...
Future<String> geoCoding(double lat, double lng) async {
  ...
  if (placemarks != null && placemarks.isNotEmpty) {
    ...
    result = '$name $street $locality $country';
  } else {
    result = 'No placemarks found';
  }
...
etaRequest() async {
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      print("here load types"+choosenVehicle);
      result = true;
      valueNotifierBook.incrementNotifier();
    } else {
      print("fail here load types"+etaDetails.toString());
      debugPrint(response.body);
    ...
    print("exception fail here load types"+e.toString());
    if (e is SocketException) {
      internet = false;
    }
  }
...
createRequest() async {
  dynamic result;
  try {
    var response = await http.post(Uri.parse('${url}api/v1/request/createnew'),
        headers: {
          'Authorization': 'Bearer ${bearerToken[0].token}',
          'Content-Type': 'application/json',
        },
